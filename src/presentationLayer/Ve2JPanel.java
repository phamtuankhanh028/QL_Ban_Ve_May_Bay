...
public class Ve2JPanel extends JPanel {
	...
	private JTable tblVebay;
	
	
	private VeBayBUS2 vbBUS = new VeBayBUS2();
	...
	public Ve2JPanel() {
		...
		JLabel lblNewLabel = new JLabel("QUẢN LÝ VÉ BAY");
		...
		JLabel lblNewLabel_3 = new JLabel("Tìm theo mã vé");
		...
		tblVebay = new MyTable();
		tblVebay.setModel(new DefaultTableModel(
			new Object[][] {
			},
			new String[] {
				"M\u00E3 V\u00E9", "M\u00E3 Tuy\u1EBFn Bay", "M\u00E3 Kh\u00E1ch H\u00E0ng", "H\u1EA1ng V\u00E9"
			}
		));
		scrollPane.setViewportView(tblVebay);
		getDsnv();
	...
	public void getDsnv() {
		dsnv=null;
		dtm = (DefaultTableModel) tblVebay.getModel();
		dtm.setRowCount(0);
		List<VeBayDTO> dsvb = vbBUS.khanh();
